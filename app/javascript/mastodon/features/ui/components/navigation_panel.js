...
const NavigationPanel = () => (
  <div className='navigation-panel'>
    ...
    {<NavLink className='column-link column-link--transparent' exact to='/timelines/public' data-preview-title-id='column.public' data-preview-icon='globe' ><Icon className='column-link__icon' id='globe' fixedWidth />Explore</NavLink> /* <FormattedMessage id='tabs_bar.federated_timeline' defaultMessage='Federated' /> */}
