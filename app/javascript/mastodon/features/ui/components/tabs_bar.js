...
export const links = [
  ...
  <NavLink className='tabs-bar__link' exact to='/timelines/public' data-preview-title-id='column.public' data-preview-icon='globe' ><Icon id='globe' fixedWidth />Explore</NavLink>,//<FormattedMessage id='tabs_bar.federated_timeline' defaultMessage='Federated' />
